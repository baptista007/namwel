...
class Html {
     ...
     * @return Html
     */
    public static function page_asset($arg) {
        ?>
        <link rel="stylesheet" href="<?php print_link(SITE_ADDR . "assets/" . $arg); ?>" />
        <?php
    }
    ...
    public static function simple_uploaded_image($filename, $style = "") {
        echo '<img src="' . SITE_ADDR . UPLOAD_FILE_DIR . $filename . '" class="img-fluid" alt="" style="' . $style . '">';
    }
}
