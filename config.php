...
define("SITE_NAME", "Namwel Tours and Safaris");

if (!file_exists(ROOT . DIRECTORY_SEPARATOR . '.env')) {
    echo "No environment variable files found in the root directory. Terminating...";
    die();
}
...
define("SMTP_USERNAME", $_ENV['APP_SMTP_USERNAME']);
define("SMTP_PASSWORD", $_ENV['APP_SMTP_PASSWORD']);
define("SMTP_HOST", $_ENV['APP_SMTP_HOST']);
define("SMTP_PORT", $_ENV['APP_SMTP_PORT']);

//Default Email Sender Details. Please set this even if you are not using SMTP
define("DEFAULT_EMAIL", $_ENV['APP_SMTP_USERNAME']);
...
define("DB_HOST", $_ENV['APP_DB_HOST']);
define("DB_USERNAME", $_ENV['APP_DB_USERNAME']);
define("DB_PASSWORD", $_ENV['APP_DB_PASSWORD']);
...
define("YOUTUBE_API_KEY", $_ENV['APP_YOUTUBE_API_KEY']);
define("YOUTUBE_CHANNEL_ID", $_ENV['APP_YOUTUBE_CHANNEL_ID']);
