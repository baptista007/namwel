        ...
        <div class="row ">
            ...
            <div class="col-md-8 comp-grid">
                ...
                <div class="bg-light p-3 animated fadeIn page-content">
                    <div>
                        <h4><i class="fa fa-key"></i> <?= get_lang('admin_login') ?></h4>
                        <hr />
                        <?php
                        $this::display_page_errors();
                        ?>
                        <form name="loginForm" action="<?php print_link('admin/login/?csrf_token=' . Csrf::$token); ?>" class="needs-validation form page-form" method="post">
                            ...
                            <div class="row clearfix mt-3 mb-3">
                                ...
                                <div class="col-6">
                                    <a href="<?php print_link('passwordmanager') ?>" class="text-danger"> <?php print_lang('reset_password'); ?></a>
                                </div>
                            </div>
