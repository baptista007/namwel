...
<div class="container">
    <div class="bg-light p-4">
        <h1 class="text-danger bold"><?= get_lang('error_server_title') ?></h1>
        <p class=" bold"><?= get_lang('error_server_subtitle') ?></p>
    </div>
    ...
    <div class="card card-body my-3">
        <p class="lead bold"><?= get_lang('error_server_contact') ?></p>
    </div>
    <div class="text-center">
        <a href="<?php print_link(HOME_PAGE); ?>" class="btn btn-primary"><?= get_lang('error_server_go_home') ?></a>
    </div>
</div>