...
//        }
    ...
    function get_options_value_name_from_enum($options_enum) {
        switch ($options_enum) {
            case FieldOptions::yes_no:
                return [
                    YesNo::yes => 'Sim',
                    YesNo::no => 'Não',
                ];
            case FieldOptions::status:
                return [
                    Status::active => 'Ativo',
                    Status::pending_review => 'Revisão pendente',
                    Status::inactive => 'Inativo(a)',
                ];
            case FieldOptions::car_body_type:
                return [
                    CarBodyType::sedan => 'Turismo',
                    CarBodyType::suv => 'SUV',
                    CarBodyType::pickup_truck => 'Carrinha',
                ];
        }
    }

    function get_field_options_from_enum($options_enum) {
        switch ($options_enum) {
            case FieldOptions::yes_no:
                return [
            ...
            case FieldOptions::status:
                return [
                    ...
                    ['value' => Status::pending_review, 'label' => 'Revisão pendente'],
                    ['value' => Status::inactive, 'label' => 'Inativo(a)'],
                ];
            case FieldOptions::car_body_type:
                return [
                    ['value' => CarBodyType::sedan, 'label' => 'Turismo'],
                    ['value' => CarBodyType::suv, 'label' => 'SUV'],
                    ['value' => CarBodyType::pickup_truck, 'label' => 'Carrinha'],
                ];
        }
    }
