...
class BaseView {
    ...
    function addNoDataFoundMsg($msg = 'No data found.', $class = 'alert-info', $icon = "fa-ban") {
        echo "<div class=\"alert $class animated bounce\">";
        echo "<i class=\"fas $icon\"></i> " . $msg;
        echo "</div>";
    }

    function addInfoDiv($msg = 'This is a information note.', $class = 'alert-info') {
        echo "<div class=\"alert $class animated bounce\">";
        echo "<i class=\"fas fa-info-circle\"></i> " . $msg;
        echo "</div>";
    }

    function addRecordNotFound($msg = 'Record not found.', $class = 'alert-warning') {
        echo "<div class=\"alert $class animated bounce\">";
        echo "<i class=\"fas fa-ban\"></i> " . $msg;
        echo "</div>";
    }
    
    function no_html($string) {
